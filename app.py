...
def extract_unique_values(columns):
    ...
    makes, models, conditions = set(), set(), set()
...
def create_exact_model_make_mapping():
    ...
    exact_mappings = {
        'bmw': ['130i', '3', '3 series', '320i', '323i', '325i', '328i', '4-runner', '5', '5 series',
                '523i', '525i', '528i', '530i', '535i', '550i', '6', '7 series', 'x3', 'x5', 'x6', 'm', 'm class'],
        'ford': ['ecosport', 'edge', 'escape', 'expedition', 'explorer', 'f-150', 'flex', 'focus', 'fusion',
                 'mustang', 'ranger', 'taurus', 'transit'],
        ...
        'mercedes-benz': ['a-class', 'c-class', 'c180', 'c200', 'c220', 'c230', 'c240', 'c250', 'c280', 'c300',
                          'c320', 'c350', 'c43', 'cla-class', 'cls', 'e200', 'e300', 'e320', 'e350', 'e550',
                          'g-class', 'gl-class', 'gla 250', 'gla-class', 'glc-class', 'gle-class', 'glk-class',
                          'gls-class', 'r-class', 's-class', 's-coupe', 'slk-class'],
        'nissan': ['almera', 'altima', 'armada', 'frontier', 'maxima', 'micra', 'murano', 'pathfinder',
                   'patrol', 'primera', 'quest', 'rogue', 'sentra', 'sunny', 'teana', 'tiida', 'titan', 'x-trail'],
        'peugeot': ['206', '307', '308', '406', '407', '408', '508', '607', '807'],
        'toyota': ['4-runner', 'avalon', 'avanza', 'camry', 'corolla', 'corolla altis', 'corolla verso',
                   'fj cruiser', 'hiace', 'highlander', 'hilux', 'land cruiser', 'land cruiser prado', 'matrix',
                   'previa', 'prius', 'rav4', 'sequoia', 'sienna', 'solara', 'tacoma', 'tundra', 'venza', 'yaris'],
        'volkswagen': ['bora', 'cc', 'golf', 'golf variant', 'jetta', 'passat', 'tiguan', 'touareg', 'vento'],
        'others': ['ilx', 'mdx', 'rdx', 'rl', 'tl', 'tsx', 'zdx', 'a4', 'a6', 'a7', 'enclave', 'lacrosse',
                   'rendezvous', 'verano', 'escalade', 'srx', 'avalanche', 'camaro', 'equinox', 'malibu',
                   '200', '300c', 'avenger', 'sebring', 'town&country', 'caliber', 'caravan', 'challenger',
                   'charger', 'durango', 'journey', 'acadia', 'yukon', 'ex', 'fx', 'fx35', 'g35', 'jx', 'm',
                   'qx4', 'qx56', 'qx60', 'qx80', 'x-type', 'xj', 'cherokee', 'commander', 'compass',
                   'grand cherokee', 'liberty', 'wrangler', 'discovery', 'freelander', 'range rover',
                   'range rover evoque', 'range rover sport', 'range rover velar', 'range rover vogue',
                   'mkc', 'mkx', 'navigator', 'lancer', 'outlander', 'pajero', 'pajero io', 'montero',
                   'cayenne', 'panamera', 'forester', 'legacy', 'outback', 'tribeca', 'vitara', 's80',
                   'xc90', 'astra', 'berlingo', 'c4', 'cl', 'cooper', 'continental', 'duster', 'galaxy',
...
# Init values
# ------------------------------
unique_values, model_make_mapping = {}, {}
if columns:
